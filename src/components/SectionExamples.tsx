    ...
    <>
      <div className="w-full flex flex-col justify-center items-center">
        ...
        <p className="text-center text-neutral-300 text-xl mt-2 mb-8 w-2/3">
          Nuestro modelo de IA interpreta las formas en cualquier imágen,
          identifica volumen, perspectiva y aplica el método Loomis para mejorar
          proporciones y guiar tu dibujo
        </p>
      </div>
